...
# install into site library so people always have the latest version
pak::pkg_install("/workspace/brad_workspace/blaseRtemplates", lib = "/opt/R/4.3.0/lib/R/site-library", upgrade = TRUE, ask = FALSE)

# get the r universe version which is likely a downgrade
# pak::pkg_install("blaseRtemplates", lib = "/opt/R/4.3.0/lib/R/site-library", upgrade = TRUE, ask = FALSE)
